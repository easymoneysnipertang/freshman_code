...
public:
	...
	void makeTree(T& element, linkedBinaryTree<T>&, linkedBinaryTree<T>&);
...
template<class T>
void linkedBinaryTree<T>::makeTree(T& element, linkedBinaryTree<T>& leftTree, linkedBinaryTree<T>& rightTree)
{
	//将左右树与element结合成一个新树
